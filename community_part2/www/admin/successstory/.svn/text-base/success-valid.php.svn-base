...
if($_POST['successValidSubmit'])
{
	...
	echo '<script language="javascript"> document.location.href = "index.php?act=success-stories&NumberStories='.$_REQUEST[norec].'&startFrom='.$_REQUEST[startLimit].'"; </script>';
}
