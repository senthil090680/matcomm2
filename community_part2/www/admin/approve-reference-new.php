...
{
	echo '<script language="javascript"> document.location.href = "added-references.php?NumberProfile='.$_REQUEST[norec].'&startFrom='.$_REQUEST[startLimit].'&status=0&spage=yes"; </script>';
}
if($_POST['addedSingleReferenceSubmit'])
{
	echo '<script language="javascript"> document.location.href = "added-references.php?ID='.$_REQUEST[ID].'&type='.$_REQUEST[type].'&status=0&spage=yes"; </script>';
}
if($_POST['modifyReferenceSubmit'])
{
	echo '<script language="javascript"> document.location.href = "added-references.php?NumberProfile='.$_REQUEST[norec].'&startFrom='.$_REQUEST[startLimit].'&status=1&spage=yes"; </script>';
}
if($_POST['modifySingleReferenceSubmit'])
{
	echo '<script language="javascript"> document.location.href = "added-references.php?ID='.$_REQUEST[ID].'&type='.$_REQUEST[type].'&status=1&spage=yes"; </script>';
}
?>
...
<table border="0" cellpadding="0" cellspacing="0" class="formborder" width="545">
<tr><td valign="top" colspan="2" class="adminformheader">Validate Multiple References</td></tr>
<tr><td colspan="2" height="5"></td></tr>
<tr bgcolor="#FFFFFF">
<td width="10"></td>
<td align="left" class="mediumtxt">
Enter Number of profiles to be display and click 'Validate' to approve the references available in for addition. 
</td></tr>
<tr>
<td width="10"></td>
<td valign="top">
<font face="Arial" size="2"><b>No.of references to be displayed: </b></font>&nbsp;
<input name="norec" size="4" value="" type="text" class="mediumtxt">
&nbsp;&nbsp;<font face="Arial" size="2"><b>Start From </b></font>&nbsp;<input name="startLimit" size="4" type="text" class="mediumtxt">&nbsp;&nbsp;&nbsp;
<input value="Validate" type="submit" name="addedReferenceSubmit" class="mediumtxt">
</td>
</tr>
<tr><td colspan="2" height="5"></td></tr>
</table>
...
<tr bgcolor="#FFFFFF">
<td width="10"></td>
<td align="left" class="mediumtxt">Matrimony Id/UserName :&nbsp;
<input name="ID" size="10" type="text" class="mediumtxt">&nbsp;<input type="radio" name="type" value="1">&nbsp;MatrimonyId&nbsp;&nbsp;<input type="radio" name="type" value="2">&nbsp;UserName
<input value="Validate" type="submit" name="addedSingleReferenceSubmit" class="mediumtxt">
<input value="Clear" type="reset" class="mediumtxt">
</td>
</tr>
<tr><td colspan="2" height="5"></td></tr>
</table>
...
<table bgcolor="#FFFFFF" border="0" cellspacing="0" cellpadding="0" width="545">
	<tr>
		<td class="mediumtxt" align="right"><div style="padding-left:7px;padding-top:5px;padding-bottom:0px;"><font color="red"><b>Modified References waiting for approval count : <?php echo $varModifyPendingCount;?></b></font></div></td>
		</tr>
</table>
<br>
...
<input name="norec" size="4" value="" type="text" class="mediumtxt">
&nbsp;&nbsp;<font face="Arial" size="2"><b>Start From </b></font>&nbsp;<input name="startLimit" size="4" type="text" class="mediumtxt">&nbsp;&nbsp;&nbsp;
<input value="Validate" type="submit" name="modifyReferenceSubmit" class="mediumtxt">
</td>
</tr>
<tr><td colspan="2" height="5"></td></tr>
</table>
...
<input type="hidden"  name="nextPage" value="yes">
<table border="0" cellpadding="0" cellspacing="0" class="formborder" width="545" bgcolor="#FFFFFF">
...
<td align="left" class="mediumtxt">Matrimony Id/UserName :&nbsp;
<input name="ID" size="10" type="text" class="mediumtxt">&nbsp;<input type="radio" name="type" value="1">&nbsp;MatrimonyId&nbsp;&nbsp;<input type="radio" name="type" value="2">&nbsp;UserName
<input value="Validate" type="submit" name="modifySingleReferenceSubmit" class="mediumtxt">
<input value="Clear" type="reset" class="mediumtxt">
</td>
</tr>
<tr><td colspan="2" height="5"></td></tr>
