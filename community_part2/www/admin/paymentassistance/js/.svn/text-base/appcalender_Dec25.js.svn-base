...
function RenderCssCal(bNewCal) {
 ...
 for (j=1;j<=Cal.GetMonDays();j++) {
  ...
  }else if (DisableAfterToday==true && j>=dayStartDisable){
 ...
 if (Cal.ShowTime) 
 {
  ...
  {vCalTime+="\n<tr>\n<td colspan='7' align='right'>";}
    ...
    if (UseImageFiles)
    {
       vCalTime+="<img onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\"); stopSpin();' src='http://www.communitymatrimony.com/admin/paymentassistance/close.gif' width='16' height='14' onmouseover='changeBorder(this,0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>";
    }
    else
    {
