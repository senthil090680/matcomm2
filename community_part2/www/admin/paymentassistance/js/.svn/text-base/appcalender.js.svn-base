...
var StartYear = servyear; //First Year in drop down year selection
...
var WeekHeadColor="#807F7F";//var WeekHeadColor="#18861B";//Background Color in Week header.
...
var SelDateColor = "";//var SelDateColor="#8DD53C";//Backgrond color of selected date in textbox.
var YrSelColor="#cc0033";//color of font of Year selector.
var MthSelColor="#cc0033";//color of font of Month selector if "MonthSelector" is "arrow".
var HoverColor="#AAAAAA"; //color when mouse move over.
var DisableColor="#DBDBDB"; //color of disabled cell.
...
var DisableAfterToday  = true; //Make date After seven days unclickable.
...
function RenderCssCal(bNewCal) {
 ...
 //******************Month and Year selector in arrow*********************************
    ...
    if (UseImageFiles)
    {
    vCalHeader+="<td><img onmousedown='javascript:Cal.DecYear();RenderCssCal();' src='"+imgs_url+"/cal_fastreverse.gif' width='13px' height='9' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>\n";//Year scroller (decrease 1 year)
    vCalHeader+="<td><img onmousedown='javascript:Cal.DecMonth();RenderCssCal();' src='"+imgs_url+"/cal_reverse.gif' width='13px' height='9' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>\n";//Month scroller (decrease 1 month)
    vCalHeader+="<td width='70%' class='calR'><font color='"+YrSelColor+"'>"+Cal.GetMonthName(ShowLongMonth)+" "+Cal.Year+"</font></td>\n"//Month and Year
    vCalHeader+="<td><img onmousedown='javascript:Cal.IncMonth();RenderCssCal();' src='"+imgs_url+"/cal_forward.gif' width='13px' height='9' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>\n";//Month scroller (increase 1 month)
    vCalHeader+="<td><img onmousedown='javascript:Cal.IncYear();RenderCssCal();' src='"+imgs_url+"/cal_fastforward.gif' width='13px' height='9' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>\n";//Year scroller (increase 1 year)
 ...
 for (i=0;i<vFirstDay;i++) {
  ...
  vDayCount=vDayCount+1;
    ...
    //Added version 1.7
    //var week_interval=7;
 var dayStartDisable = nextweekservdate;
 ...
 var strCell;
  ...
  }else if(DisableAfterToday==true && j>=dayStartDisable && dayStartDisable>=dtToday.getDate() && (Cal.Month==dtToday.getMonth())){
   strCell=GenCell(j,false,DisableColor,false);//After seven days not clickable
  }else if(DisableAfterToday==true && dayStartDisable<=dtToday.getDate() && (Cal.Year>dtToday.getFullYear()) ){
     
            if(dtToday.getMonth()==11 && Cal.Month==0 && j>=dayStartDisable){
 
                strCell=GenCell(j,false,DisableColor,false);
   }else if(dtToday.getMonth()==11 && Cal.Month==0){
 ...
 if (Cal.ShowTime) 
 {
  ...
  {   
            vCalTime+="<td align='center'><table cellspacing='0' cellpadding='0' style='line-height:0pt'><tr><td><img onmousedown='startSpin(\"Hour\", \"plus\");' onmouseup='stopSpin();' src='"+imgs_url+"/cal_plus.gif' width='13px' height='9px' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td></tr><tr><td><img onmousedown='startSpin(\"Hour\", \"minus\");' onmouseup='stopSpin();' src='"+imgs_url+"/cal_minus.gif' width='13px' height='9px' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td></tr></table></td>\n"; 
  }
  ...
  if (ShowArrows && UseImageFiles) {
     vCalTime+="</td>\n<td align='center'><table cellspacing='0' cellpadding='0' style='line-height:0pt'><tr><td><img onmousedown='startSpin(\"Minute\", \"plus\");' onmouseup='stopSpin();' src='"+imgs_url+"/cal_plus.gif' width='13px' height='9px' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td></tr><tr><td><img onmousedown='startSpin(\"Minute\", \"minus\");' onmouseup='stopSpin();' src='"+imgs_url+"/cal_minus.gif' width='13px' height='9px' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td></tr></table>"; 
  }
  ...
  {vCalTime+="\n<tr>\n<td colspan='7' align='right'>";}
    ...
    if (UseImageFiles)
    {
       vCalTime+="<img onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\"); stopSpin();' src='"+imgs_url+"/close.gif' width='16' height='14' onmouseover='changeBorder(this,0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>";
    }
    else
    {
 ...
 if (winCal == undefined) {
  ...
  cssStr+= ".calR {font-family: verdana; font-size: 12px; text-align: center; font-weight: bold;color:#FF6000;}"
    ...
    var span = document.createElement("span");
       ...
       with (span.style) {position = "absolute"; left = (xpos+8)+'px'; top = (ypos-8+50)+'px'; width = CalWidth+'px'; border = "solid 2pt " + SpanBorderColor; padding = "0pt"; cursor = "move"; backgroundColor = SpanBgColor; zIndex = 100;}
