...
# End Date		: 2011-04-06
# Project		: Community
# Module		: Payment - Optimal IVRS integration
#=============================================================================================================
...
function IVRSPaymentTracking($objMasterDB,$sessMatriId,$varPhoneVerified,$varContactMobile,$varContactPhone,$varProHighlighter) {
	...
	$argFieldsValue	= array($objMasterDB->doEscapeString($varOrderId,$objMasterDB),$objMasterDB->doEscapeString($sessMatriId,$objMasterDB),$objMasterDB->doEscapeString($varCategory,$objMasterDB),$objMasterDB->doEscapeString($varPackageCost,$objMasterDB),$objMasterDB->doEscapeString($varAmount,$objMasterDB),$objMasterDB->doEscapeString($varDiscountPercentage,$objMasterDB),$objMasterDB->doEscapeString($varDiscountFlatRate,$objMasterDB),'\'USD\'','1','\'4\'','NOW()','\'USD\'',$objMasterDB->doEscapeString($varAmount,$objMasterDB),$objMasterDB->doEscapeString($varPackageCost,$objMasterDB));
