...
function IVRSPaymentTracking($objMasterDB,$sessMatriId,$varPhoneVerified,$varContactMobile,$varContactPhone) {
	...
	global $varTable,$varCategory,$varAmount,$objOrderIdGen,$varPackageCost,$varDiscountPercentage,$varDiscountFlatRate;
	...
	$argFieldsValue	= array("'".$varOrderId."'","'".$sessMatriId."'","'".$varCategory."'","'".$varPackageCost."'","'10'","'".$varDiscountPercentage."'","'".$varDiscountFlatRate."'",'\'Rs\'','1','\'4\'','NOW()','\'Rs\'',"'".$varAmount."'","'".$varPackageCost."'");
