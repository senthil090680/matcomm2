...
#================================================================================================================
   ...
   # Filename		: photoviewpassword.php
#================================================================================================================
...
<script	language=javascript src="<?=$confValues['JSPATH'];?>/viewphoto.js"	type="text/javascript"></script> 
						...
						<!-- sub-Contant - Starts -->
							<div style="width:500px;">
								...
								<input type=hidden name="ID" value="<?=$_REQUEST['ID'];?>" >
									<div class="mediumtxt boldtxt clr3" style="text-align:left;">Photo Protected</div>
				
										<div class="divborder" style="width:470px;">
											
											<div class="smalltxt" style="padding:10px;pading-right:10px;">
											<div class="smalltxt boldtxt">Photo of <?=$_REQUEST['UNAME'];?> has been protected</div><br clear="all">
												<div class="smalltxt">To view the photo of this member, you require a password. Please enter the password below.<br><?=$varContent;?></div>
												<br clear="all">
																	
												<div style="float:left;" >
													<div class="smalltxt boldtxt" style=";float:left;">Enter photo password</div><span id="protecterror" class="errortxt" style="padding-left:10px;"></span><br clear="all">
