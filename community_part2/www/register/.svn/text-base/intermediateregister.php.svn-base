...
if ($_POST['intRegister']=='yes') {
	...
	$varFieldsValues = array($objRegister->doEscapeString($_REQUEST['weightKgs'],$objRegister),"'".$varWeightUnit."'",$objRegister->doEscapeString($_REQUEST['bodyType'],$objRegister),$objRegister->doEscapeString($_REQUEST['complexion'],$objRegister),$objRegister->doEscapeString($_REQUEST['bloodGroup'],$objRegister),"0",$objRegister->doEscapeString($_REQUEST['horoscopeMatch'],$objRegister),$objRegister->doEscapeString($_REQUEST['chevvaiDosham'],$objRegister),$objRegister->doEscapeString(trim($_REQUEST['educationDetail']),$objRegister),$objRegister->doEscapeString(trim($_REQUEST['occupationDetail']),$objRegister),$objRegister->doEscapeString($_REQUEST['eatingHabits'],$objRegister),$objRegister->doEscapeString($_REQUEST['smokingHabits'],$objRegister),$objRegister->doEscapeString($_REQUEST['drinkingHabits'],$objRegister));
	...
	$varFieldsValues = array($objRegister->doEscapeString(trim($_REQUEST['fatherOccupation']),$objRegister),$objRegister->doEscapeString(trim($_REQUEST['motherOccupation']),$objRegister),$objRegister->doEscapeString(trim($_REQUEST['familyOrgin']),$objRegister),$objRegister->doEscapeString($_REQUEST['numOfBrothers'],$objRegister),$objRegister->doEscapeString($_REQUEST['brothersMarried'],$objRegister),$objRegister->doEscapeString($_REQUEST['numOfSisters'],$objRegister),$objRegister->doEscapeString($_REQUEST['sistersMarried'],$objRegister),$objRegister->doEscapeString(trim($_REQUEST['aboutFamily']),$objRegister),"'".$varCurrentDate."'");
	...
	$varFields		 = array('Age_From','Age_To','Looking_Status','Have_Children','Height_From','Height_To','Mother_Tongue','Religion','Denomination','CasteId','SubcasteId','Star','Chevvai_Dosham','Eating_Habits','Drinking_Habits','Smoking_Habits','Education','Occupation','Citizenship','Country','Resident_India_State','Resident_USA_State','Resident_District','Resident_Status','IncludeOtherReligion','Date_Updated','StIncome','EndIncome','Partner_Description','GothramId');

	

	$varFieldsValues = array($objRegister->doEscapeString($varFromAge,$objRegister),$objRegister->doEscapeString($varToAge,$objRegister),$objRegister->doEscapeString($varPartnerLookingStatus,$objRegister),$objRegister->doEscapeString($varPartnerHavechild,$objRegister),$objRegister->doEscapeString($varHeightFrom,$objRegister),$objRegister->doEscapeString($varHeightTo,$objRegister),$objRegister->doEscapeString($varPartnerMotherTongue,$objRegister),$objRegister->doEscapeString($varPartnerReligion,$objRegister),$objRegister->doEscapeString($varPartnerDenomination,$objRegister),$objRegister->doEscapeString($varPartnerCaste,$objRegister),$objRegister->doEscapeString($varPartnerSubcaste,$objRegister),$objRegister->doEscapeString($varPartnerStar,$objRegister),$objRegister->doEscapeString($varPartnerDhosam,$objRegister),$objRegister->doEscapeString($varPartnerFoodChoice,$objRegister),$objRegister->doEscapeString($varPartnerSmokeChoice,$objRegister),$objRegister->doEscapeString($varPartnerDrinkChoice,$objRegister),$objRegister->doEscapeString($varEducation,$objRegister),$objRegister->doEscapeString($varOccupation,$objRegister),$objRegister->doEscapeString($varPartnerCitizenShip,$objRegister),$objRegister->doEscapeString($varPartnerCountry,$objRegister),$objRegister->doEscapeString($varResidingIndia,$objRegister),$objRegister->doEscapeString($varResidingUSA,$objRegister),$objRegister->doEscapeString($varResidingCity,$objRegister),"0",$objRegister->doEscapeString($varIncludeOtherReligion,$objRegister),"'".$varCurrentDate."'",$objRegister->doEscapeString($varStIncome,$objRegister),$objRegister->doEscapeString($varEndIncome,$objRegister),$objRegister->doEscapeString(trim($varPartnerDescription),$objRegister),$objRegister->doEscapeString($varpartnerGothram,$objRegister));
	...
	header("Location: ".$confValues['SERVERURL'].'/register/index.php?act=register_payment');exit;
...
if($varCompleteNow == 1) {
	...
	<div class="fright tlright"><a href="/register/index.php?act=register_payment" class="clr1 bld">Skip this page</a></div>
	<br clear="all" />
		...
		<br clear="all" />
			<div class="padb10">
				...
				<?if($varWeightKgs==0 || $varBodyType==0 || $varComplexion==0 || $varBloodGroup==0 || $varLanguagesSelected==''  || ($varUseHoroscope==1 && $varHoroscopeMatch==0) || ($varUseDosham==1 && $varChevvaiDosham==0) || $varEducationDetail=='' || $varOccupationDetail=='' || $varEatingHabits==0 || $varSmokeHabits==0 || $varDrinkHabits==0 || $varInterestsSelected=='' || $varHobbiesSelected=='' || $varMusicSelected=='' || $varSportsSelected=='' || $varFoodSelected==''	) { $varChkformAvail=1;?>
				<div class="bld clr">More about you</div>
				<?}?>
				<?if($varWeightKgs==0) {?>
				<div class="srchdivlt smalltxt fleft tlright">Weight</div>
				<div class="srchdivrt smalltxt fleft" id="stateList">
				...
				<?if($varBodyType==0) {?>
				<div class="srchdivlt smalltxt fleft tlright">Body Type</div>
				...
				<?if($varComplexion==0) {?>
				<div class="srchdivlt smalltxt fleft tlright">Complexion</div>
				<div class="srchdivrt smalltxt fleft">
				...
				<?if($varBloodGroup==0) {?>
				<div class="srchdivlt smalltxt fleft tlright">Blood Group</div>
				<div class="srchdivrt smalltxt fleft">
				...
				<div class="srchdivlt smalltxt fleft tlright">Spoken Languages</div>
				<div class="srchdivrt smalltxt fleft">
				...
				<!-- commented <? if($varUseRaasi==1) {
					if($varRaasi==0) {?>
					<div class="srchdivlt smalltxt fleft tlright"><?=$objDomainInfo->getRaasiLabel()?></div>
					<div class="srchdivrt smalltxt fleft">
				...
				<?if($varUseHoroscope==1) {
					...
					<div class="srchdivlt smalltxt fleft tlright">Want Horoscope Match?</div>
					<div class="srchdivrt smalltxt fleft">
				...
				<?if($varUseDosham==1) {
					...
					<?} else {
						...
						<div class="srchdivlt smalltxt fleft tlright"><?=$objDomainInfo->getDoshamLabel()?></div>
						<div class="srchdivrt smalltxt fleft">
				...
				<div class="srchdivlt smalltxt fleft tlright">Education in Detail</div>
				<div class="srchdivrt smalltxt fleft">
				...
				<div class="srchdivlt smalltxt fleft tlright">Occupation in Detail</div>
				<div class="srchdivrt smalltxt fleft">
				...
				<?if($varEatingHabits==0 || $varSmokeHabits==0 || $varDrinkHabits==0) {?>
					<div class="srchdivlt smalltxt fleft tlright">Habits</div>
					...
					<br>
					<div class="srchdivlt smalltxt fleft tlright"></div>
					<?}else{?>
				...
				<div class="srchdivlt smalltxt fleft tlright">Interests</div>
				<div class="srchdivrt smalltxt fleft">
				...
				<div class="srchdivlt smalltxt fleft tlright">Hobbies</div>
				<div class="srchdivrt smalltxt fleft">
				...
				<?if($varMusicSelected=='' || $varSportsSelected=='' || $varFoodSelected=='' ){?>
					<div class="srchdivlt smalltxt fleft tlright">Favourites</div>
					<?if($varMusicSelected=='') {?>
					<div class="srchdivrt smalltxt fleft">
				...
				<?}?>
				<?if($varFamilyOrigin=='') {?>
				<div class="srchdivlt smalltxt fleft tlright">Ancestral Family Origin</div>
				<div class="srchdivrt smalltxt fleft">
				...
				<div class="srchdivlt smalltxt fleft tlright">Mother's Occupation</div>
				<div class="srchdivrt smalltxt fleft">
				...
				<div class="srchdivlt smalltxt fleft tlright">Father's Occupation</div>
				<div class="srchdivrt smalltxt fleft">
				...
				<div class="srchdivlt smalltxt fleft tlright">No. of Brothers</div>
				<div class="srchdivrt smalltxt fleft">
				...
				<div class="srchdivlt smalltxt fleft tlright">Brothers Married</div>
				<div class="srchdivrt smalltxt fleft">
				...
				<div class="srchdivlt smalltxt fleft tlright">No. of Sisters</div>
				<div class="srchdivrt smalltxt fleft">
				...
				<div class="srchdivlt smalltxt fleft tlright">Sisters Married</div>
				<div class="srchdivrt smalltxt fleft">
				...
				<?if($varAboutFamily=='') {?>
				<div class="srchdivlt smalltxt fleft tlright">Few lines about your family</div>
				<div class="srchdivrt smalltxt fleft">
                ...
                <div class="bld clr tlleft padb10">More about your partner<br clear="all"/><font class="smalltxt notbld">The fields marked with a (<img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />) will form your MatchWatch criteria. You will receive daily matches based on your MatchWatch criteria.</font></div>
                <div class="srchdivlt smalltxt fleft tlright"><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;Age</div>
				...
				<div class="srchdivlt smalltxt fleft tlright"><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;Height</div>
				<div class="srchdivrt smalltxt fleft">
				...
				<div class="srchdivlt smalltxt fleft tlright"><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;Physical Status</div>
				<div class="srchdivrt smalltxt fleft" >
				...
				<? if($varUseMaritalStatus==1) {
					...
					?>
					<div class="srchdivlt smalltxt fleft tlright"><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;<?=$objDomainInfo->getMaritalStatusLabel()?></div>
					<div class="srchdivrt smalltxt fleft"><div class="fleft">
					<div style="width:120px;" class="fleft"><input type="checkbox"  name="lookingStatus[]"  id="lookingStatus" value='0' onClick="(partnerHaveChildnp());maritalstany(1);"><font class='smalltxt' style="padding-left:5px;">Any&nbsp;</font></div>
					<?php foreach($arrRetMaritalStatus as $key=>$value){
						$varChecked = ($key == $varPartnerLookingStatus)?'checked':'';
						echo '<div style="width:120px !important;width:120px;float:left"><input style="padding-right:10px;" type="checkbox" name="lookingStatus[]" value="'.$key.'"  id="lookingStatus" onClick="partnerHaveChildnp();maritalstany(2);" '.$varChecked.'><font class="smalltxt" style="padding-left: 5px;">'.$value.'</font></div>';
					}?>
					</div>
					</div>
					<br clear="all"/>
				...
				<div class="srchdivrt smalltxt fleft" >
					<? $index=1; foreach($arrPartnerChilrenLivingStatusList as $key=>$value){
						...
						if($index > 3) echo "<br>";
						echo '<input type="radio" name=partnerHavechild value="'.$key.'"  id="haveChilrenStatus'.$key.'" '.$varChecked.'><font class="smalltxt" style="padding-right: 10px;">'.$value.'</font>';
					$index++;}?>
				</div><br clear="all"/>
				</div>

				<div class="srchdivlt smalltxt fleft tlright"><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;Mother Tongue</div>
				<div class="srchdivrt smalltxt fleft"><div class="fleft">
				...
				<? if($varUseReligion) {
					...
					if (sizeof($arrGetReligionOption)>1) {
						?>
						<div class="srchdivlt smalltxt fleft tlright"><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;<?=$objDomainInfo->getReligionLabel()?></div>
						<div class="srchdivrt smalltxt fleft"><div class="fleft">
			...
			if($isReligion==1 && $varCommunityId !=2500 && $varCommunityId !=2503 && $varCommunityId !=2502 && $varCommunityId !=2501 && $varCommunityId !=2504){
                $isMoreReligion = $objDomainInfo->getReligionOption();
				if(count($isMoreReligion) > 1){
					echo '<input type="checkbox" tabindex="'.($varTabIndex++).'" name="IncludeOtherReligion" value="1"><font class="smalltxt">Include matching profile from other religion also</font>';
				}else{
				...
				<? if($varUseDenomination) {
					...
					if (sizeof($arrGetDenominationOption)>1) {
						?>
						<div class="srchdivlt smalltxt fleft tlright"><?=$showBr;?><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;<?=$objDomainInfo->getDenominationLabel()?></div>
						<div class="srchdivrt smalltxt fleft"><div class="fleft">
				...
				<? if($varUseCaste && $varIsCasteMandatory == 1) {
					...
					if (sizeof($arrGetCasteOption)>1) {
						?>
						<div class="srchdivlt smalltxt fleft tlright"><?=$showBr;?><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;<?=$objDomainInfo->getCasteLabel();?></div>
						<div class="srchdivrt smalltxt fleft"><div class="fleft">
				...
				if (sizeof($arrGetStarOption)>1) {
						?>
				<div class="srchdivlt smalltxt fleft tlright"><?=$showBr;?>Star</div>
				<div class="srchdivrt smalltxt fleft"><div class="fleft">
				...
				<? if($varUseSubcaste && $varIsSubcasteMandatory==1) {
					...
					if (sizeof($arrGetSubcasteOption)>1) {
						?>
						<div class="srchdivlt smalltxt fleft tlright"><?=$showBr;?>Sub caste</div>
						<div class="srchdivrt smalltxt fleft"><div class="fleft">
				...
				<div class="srchdivlt smalltxt fleft tlright"><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;Gothra</div>
				<div class="srchdivrt smalltxt fleft">
					<div class="srchdivrt smalltxt fleft"><div class="fleft">
				...
				<? if($_FeatureDosham == 1) {
					...
					<?} else {
						...
						<div class="srchdivlt smalltxt fleft tlright"><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;Chevvai Dosham</div>
						<div class="srchdivrt smalltxt fleft"><div class="fleft">
							<input type="checkbox" name="partnerDhosam[]"  id="partnerDhosam"value='0' checked><font class='smalltxt'>Doesn't matter&nbsp;</font>
							<?php foreach($arrTmpDoshamList as $key=>$value){
							    echo '<input type="checkbox" name="partnerDhosam[]" value="'.$key.'"  id="partnerDhosam"><font class="smalltxt" style="padding-right: 10px;" >'.$value.'</font>';
							}?>
							</div><br clear="all">
						</div><br clear="all"/>
						<!--<div class="srchdivrt smalltxt fleft">
				...
				<? } ?>
                        ...
                        <!--<div class="srchdivlt smalltxt fleft tlright"><?=$objDomainInfo->getGothramLabel()?></div>
						<div class="srchdivrt smalltxt fleft"><div class="fleft">
				...
				<div class="srchdivlt smalltxt fleft tlright"><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;Food habits</div>
				<div class="srchdivrt smalltxt fleft">
					<div style="width:120px;" class="fleft"><input type="checkbox" name="partnerFoodChoice[]"  id="partnerFoodChoice"value='0' checked onClick="eatingHabitschk(1);"><font class='smalltxt' style="padding-left:10px;">Doesn't matter&nbsp;</font></div>
					<?php foreach($arrEatingHabitsList as $key=>$value){
						echo '<div style="width:120px !important;width:120px;float:left"><input type="checkbox" name="partnerFoodChoice[]" value="'.$key.'"  id="partnerFoodChoice" onClick="eatingHabitschk(2);"><font class="smalltxt" style="padding-left: 10px;">'.$value.'</font></div>';
					}?>
				...
				<div class="srchdivlt smalltxt fleft tlright">Smoking Habits</div>
				<div class="srchdivrt smalltxt fleft">
					<div style="width:120px;" class="fleft"><input type="checkbox" name="partnerSmokeChoice[]"  id="partnerSmokeChoice"value='0' checked onClick="smokingHabitschk(1);"><font class='smalltxt' style="padding-left:10px;">Doesn't matter&nbsp;</font></div>
					<?php foreach($arrSmokeList as $key=>$value){
						echo '<div style="width:130px !important;width:130px;float:left"><input type="checkbox" name="partnerSmokeChoice[]" value="'.$key.'"  id="partnerSmokeChoice" onClick="smokingHabitschk(2);"><font class="smalltxt" style="padding-left: 10px;">'.$value.'</font></div>';
					}?>
				</div><br clear="all"/>

				<div class="srchdivlt smalltxt fleft tlright">Drinking Habits</div>
				<div class="srchdivrt smalltxt fleft">
					<div style="width:120px;" class="fleft"><input type="checkbox" name="partnerDrinkChoice[]"  id="partnerDrinkChoice"value='0' checked onClick="drinkingHabitschk(1);">
					<font class='smalltxt' style="padding-left: 10px;">	Doesn't matter&nbsp;</font></div>
					<?php foreach($arrDrinkList as $key=>$value){
						echo '<div style="width:130px !important;width:130px;float:left"><input type="checkbox" name="partnerDrinkChoice[]" value="'.$key.'"  id="partnerDrinkChoice" onClick="drinkingHabitschk(2);"><font class="smalltxt" style="padding-left: 10px;">'.$value.'</font></div>';
					}?>
				</div><br clear="all"/>

				<div class="srchdivlt smalltxt fleft tlright"><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;Education</div>
				<div class="srchdivrt smalltxt fleft"><div class="fleft">
				...
				<div class="srchdivlt smalltxt fleft tlright"><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;Citizenship</div>
				<div class="srchdivrt smalltxt fleft"><div class="fleft">
                ...
                <? } else { ?>
				<div class="srchdivlt smalltxt fleft tlright"><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;Country Living In</div>
				<div class="srchdivrt smalltxt fleft"><div class="fleft">
			   ...
			   <div id="indstate" style="display:none;">
				<div class="srchdivlt smalltxt fleft tlright"><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;Residing India State</div>
				<div class="srchdivrt smalltxt fleft"><div class="fleft">
				...
				<? if($confValues["DOMAINCASTEID"] != 2006) { ?>
				<div class="srchdivlt smalltxt fleft tlright"><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;Residing USA State</div>
				<div class="srchdivrt smalltxt fleft"><div class="fleft">
				...
				<div class="srchdivlt1 smalltxt fleft" id="annualincometo" style="display:none;padding-left:40px;">
				...
				<br clear="all"/>
				<div class="srchdivlt smalltxt fleft tlright">Few lines about my partner</div>
				<div class="srchdivrt smalltxt fleft" ><textarea class="tareareg" name="partnerDescription" style="resize: none;"></textarea><br />
				</div><br clear="all">
...
function change_state1(){
  ...
  function annualincomevalidation1(){
