...
<table width="100%" border="0" cellspacing="10" cellpadding="0" align="center">
	...
	<tr><td width="75%" bgcolor="#E6F2D5" class="formborderclr">
		<p class="logouthead1" style="margin:0px;padding:10px;text-align:justify;color:#333333;">Dear Member,<br>You have logged out of MuslimMatrimonial.com. Thank you for using our services.</p>
	</td>
	<td width="25%">
