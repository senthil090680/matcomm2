...
<style>.srchselect {width: 180px;}</style>
		...
		<center>
			<div class="padt10">
				...
				<input type='hidden' name='oldpartnerdesc' value='<?=htmlentities($varMemberInfo['Partner_Description'],ENT_QUOTES)?>'>
				...
				<font class="smalltxt notbld"> Here you can customize your partner preference. You will receive matches by e-mail based on the highlighted fields (<img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />) below which form your MatchWatch criteria. Profiles that exactly match your partner preference are tagged as "Preferred Profile."</font></div>
				<? if($varMStatusFeature==1) {
					if($varSizeMaritalStatus>1) {
					?>
						<div class="smalltxt fleft tlright srchdivlt"><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;<?=$objDomain->getMaritalStatusLabel()?></div>
				...
				<div class="smalltxt fleft tlright srchdivlt"><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;Age</div>
				...
				<div class="smalltxt fleft tlright srchdivlt"><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;Height</div>
				...
				<div class="smalltxt fleft tlright srchdivlt"><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;Physical Status</div>
				<div class="fleft pfdivrt tlleft" >
				...
				<? if($objDomain->useMotherTongue()) {
					...
					?>
						<div class="smalltxt fleft tlright srchdivlt"><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;<?=$objDomain->getMotherTongueLabel()?></div>
				...
				<? if($objDomain->useReligion()) {
					...
					?>
						<div class="smalltxt fleft tlright srchdivlt"><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;<?=$objDomain->getReligionLabel()?></div>
				...
				$isMoreReligion = $objDomain->getReligionOption();   
				 ...
				 <? if($objDomain->useDenomination()) {
					...
					?>
						<div class="smalltxt fleft tlright srchdivlt"><?=$showBr;?><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;<?=$objDomain->getDenominationLabel()?></div>
						<div class="fleft srchdivrt tlleft" ><div class="fleft">
			  ...
			  <? } ?>
                 ...
                 <? if($objDomain->useGothram()) {
		            ...
		            if($varSizeGothram > 1) {
					  ?>
						<div class="smalltxt fleft tlright srchdivlt" ><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;<?=$objDomain->getGothramLabel()?></div>
					...
					if($varSizeDosham>1) {
					?>
						<div class="smalltxt fleft tlright srchdivlt"><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;<?=$objDomain->getDoshamLabel()?></div>
						<div class="fleft srchdivrt tlleft" >
				...
				<div class="smalltxt fleft tlright srchdivlt"><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;Education in Detail</div>
				...
				<? } else { ?>
				<div class="smalltxt fleft tlright srchdivlt"><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;Citizenship</div>
			...
			<div class="fleft"><select name="countryLivingInTemp[]" id="countryLivingInTemp" size="4" multiple class="srchselect" ondblclick="moveOptions(this.form.countryLivingInTemp, this.form.countryLivingIn);changeincome();fnAnyChk(document.frmProfile.countryLivingInTemp,document.frmProfile.countryLivingIn);"> <?=$objCommon->getValuesFromArray($arrCountryList, "Any", "0", "");?></select></div><div class="fleft padlr10 padt5"><input type="button" value=" > " class="button"  onclick="moveOptions(this.form.countryLivingInTemp, this.form.countryLivingIn);changeincome();fnAnyChk(document.frmProfile.countryLivingInTemp,document.frmProfile.countryLivingIn);"><br><img src="<?=$confValues['IMGSURL'].'/trans.gif';?>" width="1" height="5" /><br><input type="button" value=" < " class="button" onclick="change_state1();moveOptions(this.form.countryLivingIn, this.form.countryLivingInTemp);changeincome();"></div><div class="fleft"><select class="srchselect" size="4" multiple id="countryLivingIn" name="countryLivingIn[]" ondblclick="change_state1();moveOptions(this.form.countryLivingIn, this.form.countryLivingInTemp);changeincome();">
			...
			<div class="fleft"><select name="countryLivingInTemp[]" id="countryLivingInTemp" size="4" multiple ondblclick="moveOptions(this.form.countryLivingInTemp, this.form.countryLivingIn);changeincome();fnAnyChk(document.frmProfile.countryLivingInTemp,document.frmProfile.countryLivingIn);"> <?=$objCommon->getValuesFromArray($arrCountryList, "Any", "0", "");?></select>
			...
			<div class="srchdivrt smalltxt fleft tlleft">
			<div class="fleft"><select id="residingIndiaTemp" name="residingIndiaTemp[]"   size="4" ondblclick="moveOptions(this.form.residingIndiaTemp, this.form.residingIndia);ajaxEditInterCityCall('<?=$confValues['SERVERURL']?>/register/regstatecity.php',<?=$varTabIndex?>,'');change_citycount();fnAnyChk(document.frmProfile.residingIndiaTemp,document.frmProfile.residingIndia);" multiple class="srchselect">
					<?=displaySelectedValuesFromArray($arrResidingStateList,"");?>				
			</select>
			</div>			
			<div class="fleft padlr10 padt5"><input type="button" value=" > " class="button" onclick="moveOptions(this.form.residingIndiaTemp, this.form.residingIndia);ajaxEditInterCityCall('<?=$confValues['SERVERURL']?>/register/regstatecity.php',<?=$varTabIndex?>,'');change_citycount();fnAnyChk(document.frmProfile.residingIndiaTemp,document.frmProfile.residingIndia);"><br><img src="<?=$confValues['IMGSURL'].'/trans.gif';?>" width="1" height="5" /><br><input type="button" value=" < " class="button" onclick="moveOptions(this.form.residingIndia, this.form.residingIndiaTemp);ajaxEditInterCityCall('<?=$confValues['SERVERURL']?>/register/regstatecity.php',<?=$varTabIndex?>,'');change_citycount();"></div><div class="fleft"><select class="srchselect" size="4" multiple name="residingIndia[]" id="residingIndia" ondblclick="moveOptions(this.form.residingIndia, this.form.residingIndiaTemp);ajaxEditInterCityCall('<?=$confValues['SERVERURL']?>/register/regstatecity.php',<?=$varTabIndex?>,'');change_citycount();">
  			<?php  
			...
			<div class="srchdivrt smalltxt fleft tlleft">
			<div class="fleft"><select id="residingUSATemp" name="residingUSATemp[]" size="4" ondblclick="moveOptions(this.form.residingUSATemp, this.form.residingUSA);fnAnyChk(document.frmProfile.residingUSATemp,document.frmProfile.residingUSA);" multiple class="srchselect">
				
				<?=displaySelectedValuesFromArray($arrUSAStateList,"");?>
			</select>
			</div>			
		...
		<div class="normtxt clr bld fleft padl25 padt10">Lifestyle - Habits</div><br clear="all"/>
				<?php if(sizeof($arrEatingHabitsList)>1){?><div class="smalltxt fleft tlright srchdivlt"><img src="<?=$confValues['IMGSURL']?>/prmok.jpg" />&nbsp;&nbsp;Food</div>
			...
			<div class="normtxt fleft tlright srchdivlt bld">Few lines about my partner</div>
				<div class="fleft pfdivrt tlleft" ><textarea style="resize:none;" class="tareareg" name="partnerDescription"><?=stripslashes(htmlentities($varMemberInfo['Partner_Description'],ENT_QUOTES))?></textarea><br />
				</div><br clear="all">				
...
if(selectedStates!='' && checkValueInArray(arrCountry,98) == true){	
