...
include_once($varBaseRootPath.'/conf/dbainfo.inc');
...
$varFileContent	= file($varRootPath.'/newdata-conversion/photo-protect-info'.$JJ.'.txt');
...
for($i=0; $i<$varNoOfLines; $i++)
{
	...
	$varTableName	= $varDbaInfo['TEMPDATABASE'].'.comm_memberphotoinfo';
	...
	if($varRows == 1)
	{
		...
		$varTableName	= $varDbaInfo['TEMPDATABASE'].'.comm_memberinfo';
