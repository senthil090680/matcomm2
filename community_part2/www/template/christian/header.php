...
<div style="overflow:auto;">
	<div style="width:772px;height:75px;" class="topbgclr">
		<div class="fleft logodiv" style="padding-left:15px;"><a href="<?=$confValues['SERVERURL']?>/<?=$sessMatriId ? 'profiledetail/' : ''?>"><img src="<?=$confValues['IMGSURL']?>/logo/christianlogo.gif" alt="<?=ucfirst($arrDomainInfo[$varDomain][2])?>Matrimony" border="0" /></a></div>
