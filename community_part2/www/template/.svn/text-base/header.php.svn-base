...
if($varSrchCont!=''){
	$varSrchCont .= '<div class="fleft padt5" style="padding-left:15px;"><a class="menclr1 smalltxt" href="'.$confValues['SERVERURL'].'/search/index.php?act=savesearch">More>></a></div></div>'; 
}
}
?>
...
<div style="background-color:#FFFFFF;overflow:auto;">
	<div style="width:772px;height:75px;">
		...
		<!-- <div class="fright" style="padding-top:20px;">
			<div class="hgt33 wdth103 fleft" style="background:url(http://img.communitymatrimony.com/images/livehelpbg.gif) left top no-repeat">
				<div class="pdt8 pdl20 clr1 bld normtxt">24/7 Support</div>
			</div>
			<div style="background:#EDEDED;height:25px !important;height:33px;" class="fleft pdt8 pdl10 clr normtxt">
				<div class="fleft clr9">Toll Free&nbsp;:&nbsp;&nbsp;</div><div id="livehelpno" class="fleft"></div> &nbsp;&nbsp;|&nbsp;&nbsp;<a href="/site/index.php?act=LiveHelp" class="clr1 smalltxt">Live Help</a>&nbsp;
			</div>
			<div class="fleft hgt33" style="width:7px;background:url(http://img.communitymatrimony.com/images/livehelp2.gif) left top no-repeat">&nbsp;</div>
		</div> -->
		...
		<div style="width:772px;">
			<div class="normtxt clr2 fleft" style="width:475px;">
				...
				<? } else if ($varDomainPart2!='communitymatrimony'){ ?>
					...
					<div onclick="showhidediv('searchdiv');hidediv('messagediv');return true;" class="<?=$varTopMenu=='search' ? 'clract fleft tlcenter menust1' : 'menclr fleft tlcenter menust1';?>" class="fleft tlcenter menust1" id="menusrch" onmouseover="document.getElementById('menusrch').className='tlcenter fleft menust2';imgchange('simg1');" onmouseout="document.getElementById('menusrch').className='<?=$varTopMenu=='search' ? 'tlcenter fleft clract fleft menust2':'tlcenter fleft menust1'?>';imgchange('<?=$varTopMenu=='search' ? 'simg1':'simg'?>');" style="cursor:pointer;"><a class="padlr10 menclr">Search <span id="simg" class="<?=$varTopMenu=='search' ? 'pntr disnon' : 'pntr';?>" class="fleft tlcenter menust1" id="menumsg" onmouseover="document.getElementById('menumsg').className='tlcenter fleft menust2';"><img src="<?=$confValues['IMGSURL']?>/menuarr1.gif" border="0" /></span><span id="simg1" class="<?=$varTopMenu=='search' ? 'pntr' : 'pntr disnon';?>"><img src="<?=$confValues['IMGSURL']?>/menuarr2.gif" border="0"/></span></a></div>
...
<!-- Message menu content -->
	...
	<div style="padding-left:<?=$varSrchPleftm;?> !important;padding-left:<?=$varSrchPleftie;?>;position:absolute;top:113px;">
		...
		<div class="fleft" style="padding-right:5px;"><font class="bld menclr1">Search options</font><br><img src="<?=$confValues['IMGSURL']?>/oarrow.gif" hspace="5" /><a class="menclr1" href="<?=$confValues['SERVERURL']?>/search/" onclick="hidediv('searchdiv'); return true;" onmouseover="showdiv('searchdiv'); return true;">Regular search</a><br><img src="<?=$confValues['IMGSURL']?>/oarrow.gif" hspace="5" />
		<a class="menclr1" href="<?=$confValues['SERVERURL']?>/search/index.php?act=advsearch" onclick="hidediv('searchdiv'); return true;" onmouseover="showdiv('searchdiv'); return true;">Advanced search</a><br><img src="<?=$confValues['IMGSURL']?>/oarrow.gif" hspace="5" />
