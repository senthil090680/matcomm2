...
$varCondition				= " WHERE Last_Login >='".$varStartDate."' AND Last_Login <='".$varEndDate."'";
...
$varProfileDetails	= '';
$varProfileDetails	.='<table border="0" cellpadding="2" cellspacing="1" align="left" width="20%" style="font-family: Verdana, MS Sans serif, Arial, Helvetica, sans-serif; font-size: 11px;">';
...
$varProfileDetails	.='<tr>
	<td class="smalltxt" width="200" colspan="2"><hr></td></tr>';
$varProfileDetails	.='<tr>
		<td class="smalltxt">Paid Profiles : </td>
...
$varProfileDetails	.='<tr>
	<td class="smalltxt" width="200" height="25" colspan="2">&nbsp;&nbsp;</td>';
/* $varProfileDetails	.='<tr><td class="smalltxt" height="15" colspan="2"><b> Gender Details </b> </td></tr>';
$varProfileDetails	.='<tr>
	<td class="smalltxt" width="200" colspan="2"><hr></td></tr>';
...
//$varProfileDetails	.='<tr><td class="smalltxt">Total Login Members :</td><td>'.$varLoginInfo.'</td></tr>';
...
if ($varPaidProfiles > 0 ) {
	...
	//<tr><td class="smalltxt" height="25" colspan="6"><hr></td></tr>
	$varPaymentDetails	.= '<tr><td colspan="0" height="5"  valign="middle" align="right" class="smalltxt"><b>Total&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;</b></td><td class="smalltxt"><b>';
...
$varHeading				= '<table width="100%"> <tr><td> <h3>[Community Matrimony - CBS]['.strftime("%d-%B-%Y",strtotime($varDate)).']</h3></td></tr></table>';
$argFrom = "webmaster";
...
$argToEmailAddress 		= "sai@bharatmatrimony.com,ashokkumar@bharatmatrimony.com,dhanapal@bharatmatrimony.com";
$argSubject		   		= "[Community Matrimony - CBS]".strftime("%d-%B-%Y",strtotime($varDate))."]";
