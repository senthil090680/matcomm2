...
include_once($varRootPath."/mailer/newlook/muslim/benefits-tmpl.php");
...
for($i=0; $i<1; $i++){
	...
	//CONTROL STATEMENT
	$varAllDetails	= file($varRootPath.'/mailer/newlook/muslim/userinfo'.$i.'.txt');
	$varSleepCount  = 0;
	...
	foreach($varAllDetails as $varSingleDetail)
	{
		...
		$varSubject		= 'Exciting benefits on MuslimMatrimony. Login and check it out.';
