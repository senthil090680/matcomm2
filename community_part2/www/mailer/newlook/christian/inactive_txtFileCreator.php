<?php
//FILE INCLUDES
include_once('/home/product/christian/conf/ip.inc');

//connect mysql
$mysql_connection	= mysql_connect($varDbIP['S'],$varDBUserName,$varDBPassword) or die('connection_error');
$mysql_select_db	= mysql_select_db("cmatrimony") or die('db_selection_error');

$varQuery	= " SELECT A.User_Name,A.Email FROM cmatrimony.memberlogininfo A, cmatrimony.memberinfo B  WHERE A.MatriId=B.MatriId AND B.Date_Created < '2009-04-25 00:00:00' AND B.Last_Login < '2009-04-25 00:00:00' ";
