var chkSelbox = new Array('motherTongue','religion','denomination','casteDivision','subCaste','star','gothram','raasi','education','employedIn','occupation','citizenship','countryLivingIn','residingIndia','residingUSA','residingCity','manglik','eatingHabits','smokingHabits','drinkingHabits');
...
function fnStateAnyChk(frobj,toobj,tabindex){
  var selFrLength=frobj.length;
  var selToLength=toobj.length;
  var iAnyFound=0;
