function funAddPrivilegemat(param){
      var frmName=document.frmPrivilege
      if(frmName.name.value != '' && frmName.name.value != 'Name' && frmName.phone.value != '' && frmName.phone.value != 'Phone no' && frmName.city.value != '' && frmName.city.value != 'City') {
	  ...
	  else if(frmName.phone.value == '' || frmName.phone.value == 'Phone no') {
...
function ajxRegPriRes(){
    if(objAjx.readyState==4)
	{
	 ...
	 var frmName=document.frmPrivilege;
     frmName.name.value = 'Name';frmName.phone.value = 'Phone no';frmName.city.value = 'City';
	}
}