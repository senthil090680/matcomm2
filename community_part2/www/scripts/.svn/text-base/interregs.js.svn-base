var chkSelbox = new Array('lookingStatusTemp','motherTongue','partnerReligion','partnerDenomination','partnerCaste','partnerSubcaste','education','occupation','countryLivingIn','residingIndia','residingUSA','residentStatus','partnerStar','citizenship','partnerFoodChoice','partnerSmokeChoice','partnerDrinkChoice','partnerDhosam','residingCity','partnerGothram');
