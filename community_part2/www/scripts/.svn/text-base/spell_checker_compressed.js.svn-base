var akamaiimagepath = varConfArr['domainimgs']+'/';var cp = new cpaint(); cp.set_transfer_mode('post'); cp.set_response_type('text'); var currObj; var spellingSuggestionsDiv = null; if(document.onclick)
...
{ currObj.actionSpan.innerHTML = "<a class=\"check_spelling clr1\" onclick=\"setCurrentObject(" + currObj.config['varName'] + "); " + currObj.config['varName'] + ".spellCheck();\"><img src=\""+akamaiimagepath+"spellcheck.png\" width=\"16\" height=\"16\" title=\"Check Spelling &amp; Preview\" alt=\"Check Spelling &amp; Preview\" border=\"0\" /></a>";}
else
{ currObj.actionSpan.innerHTML = "<img src=\""+akamaiimagepath+"checkspellicon.gif\" border='0' width='19' height='18' hspace='5'> <a onclick=\"setCurrentObject(" + currObj.config['varName'] + "); " + currObj.config['varName'] + ".spellCheck();\"><font class='smalltxt clr1 pntr'>Check Spelling &amp; Preview</font></a><div style='background-color:#ffffff;float:left;'><img src=\""+akamaiimagepath+"trans.gif\" width='1' height='5'></div>";}
...
{ currObj.actionSpan.innerHTML = "<a class=\"resume_editing\" onclick=\"setCurrentObject(" + currObj.config['varName'] + "); " + currObj.config['varName'] + ".resumeEditing();\"><img src=\""+akamaiimagepath+"page_white_edit.png\" width=\"16\" height=\"16\" title=\"Resume Editing\" alt=\"Resume Editing\" border=\"0\" /></a>";}
else
{ currObj.actionSpan.innerHTML = "<font class='smalltxt1'><b>Note:</b> Highlighted words could be possibly mis-spelt.  Please correct these words before you resume typing.</font><br><img src=\""+akamaiimagepath+"trans.gif\" width='1' height='5'><br><a style='cursor: pointer' class='smalltxt clr1' onclick=\"setCurrentObject(" + currObj.config['varName'] + "); " + currObj.config['varName'] + ".resumeEditing();\">Resume Editing</a>";}
if(isThereAMisspelling != "1")
{ if(currObj.config['useIcons'])
{ currObj.statusSpan.innerHTML = "<img src=\""+akamaiimagepath+"accept.png\" width=\"16\" height=\"16\" title=\"No Errors Found\" alt=\"No Errors Found\" border=\"0\" />";}
else
{ currObj.statusSpan.innerHTML = "<font class='smalltxt clr3'>No Errors Found</font><div style='float:left'><img src=\""+akamaiimagepath+"trans.gif\" width='1' height='5'></div><br clear='all'>";}
currObj.objToCheck.disabled = false;}else{currObj.statusSpan.innerHTML = "<div style='float:left'><img src=\""+akamaiimagepath+"trans.gif\" width='1' height='5'></div><br clear='all'>";currObj.objToCheck.disabled = false;}
}; function spellCheck() { if(document.getElementById('description1').value!=""){with(currObj); var query; if(currObj.spellingResultsDiv)
{ currObj.spellingResultsDiv.parentNode.removeChild(currObj.spellingResultsDiv); currObj.spellingResultsDiv = null;}
if(currObj.config['useIcons'])
{ currObj.actionSpan.innerHTML = "<img src=\""+akamaiimagepath+"+spellcheck.png\" width='16' height='16' title='Check Spelling &amp; Preview' alt='Check Spelling &amp; Preview' border='0' />";}
else
{ currObj.actionSpan.innerHTML = "<a class='smalltxt clr1 pntr'>Check Spelling &amp; Preview</a><br><img src=\""+akamaiimagepath+"trans.gif\" width='1' height='5'>";}
if(currObj.config['useIcons'])
{ currObj.statusSpan.innerHTML = "<img src=\""+akamaiimagepath+"working.gif\" width=\"16\" height=\"16\" title=\"Checking...\" alt=\"Checking...\" border=\"0\" />";}
else
{ currObj.statusSpan.innerHTML = "Checking...<div style='float:left'><img src=\""+akamaiimagepath+"trans.gif\" width='1' height='5'></div><br clear='all'>";}
query = currObj.objToCheck.value; query = query.replace(/\r?\n/gi, "<br />"); cp.call(currObj.config['spellUrl'], 'spellCheck', spellCheck_cb, query, currObj.config['varName']);}else{document.getElementById('description1').focus();return false}}; function addWord(id)
...
if(currObj.config['useIcons'])
{ currObj.statusSpan.innerHTML = "<img src=\""+akamaiimagepath+"working.gif\" width=\"16\" height=\"16\" title=\"Adding Word...\" alt=\"Adding Word...\" border=\"0\" />";}
else
...
{ currObj.statusSpan.innerHTML = "<img src=\""+akamaiimagepath+"working.gif\" width=\"16\" height=\"16\" title=\"Searching...\" alt=\"Searching...\" border=\"0\" />";}
else
...
{ with(currObj); if(currObj.config['useIcons'])
{ currObj.actionSpan.innerHTML = "<a class=\"resume_editing\"><img src=\""+akamaiimagepath+"page_white_edit.png\" width=\"16\" height=\"16\" title=\"Resume Editing\" alt=\"Resume Editing\" border=\"0\" /></a>";}
else
{ currObj.actionSpan.innerHTML = "<a class=\"resume_editing\">Resume Editing</a>";}
if(currObj.config['useIcons'])
{ currObj.statusSpan.innerHTML = "<img src=\""+akamaiimagepath+"working.gif\" width=\"16\" height=\"16\" title=\"Working...\" alt=\"Working...\" border=\"0\" />";}
else
{ currObj.statusSpan.innerHTML = "Working...<div style='float:left'><img src=\""+akamaiimagepath+"trans.gif\" width='1' height='5'></div><br clear='all'>";}
if(spellingSuggestionsDiv)
{ spellingSuggestionsDiv.parentNode.removeChild(spellingSuggestionsDiv); spellingSuggestionsDiv = null;}
...
{ currObj.actionSpan.innerHTML = "<img src=\""+akamaiimagepath+"checkspellicon.gif\" border='0' width='19' height='18' hspace='5'> <a class='smalltxt clr1 pntr' onclick=\"setCurrentObject(" + currObj.config['varName'] + "); " + currObj.config['varName'] + ".spellCheck();\">Check Spelling &amp; Preview</a><br><img src=\""+akamaiimagepath+"trans.gif\" width='1' height='5'><br>";}
