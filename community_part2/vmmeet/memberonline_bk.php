...
//$endtime_val = 1;
//if(($endtime_val!=1))
//echo "endtime_val".$endtime_val.">event_endtimeval:".$event_endtimeval;
	...
	<div id="container">
		...
		<div style="float:left;width:772px;">
			...
			<div class="middiv-pad">		
					...
					<div class="fleft" style="background: url(http://<?=$_SERVER[SERVER_NAME];?>/images/omm-top-img1-new.jpg) no-repeat; width:470px; height:159px;">
						<div class="fleft smalltxt" style="padding: 0px 0px 0px 15px;margin-top:60px">
								<div  class="clr4"><img width="4" hspace="5" height="7" src="http://<?=$_SERVER[SERVER_NAME];?>/images/vmm-arrow.gif"/>Modern day Virtual Swayamvar<br/><img src="http://<?=$_SERVER[SERVER_NAME];?>/images/trans.gif" width="1" height="3" hspace="5"/><br/>
								<img width="4" hspace="5" height="7" src="http://<?=$_SERVER[SERVER_NAME];?>/images/vmm-arrow.gif"/>Connect with members of your community from across the world<br/><img src="http://<?=$_SERVER[SERVER_NAME];?>/images/trans.gif" width="1" height="3" hspace="5"/><br/>
								<img width="4" hspace="5" height="7" src="http://<?=$_SERVER[SERVER_NAME];?>/images/vmm-arrow.gif"/>Chat and Interact real time<br/><img src="http://<?=$_SERVER[SERVER_NAME];?>/images/trans.gif" width="1" height="3" hspace="5"/><br/>
								<img width="4" hspace="5" height="7" src="http://<?=$_SERVER[SERVER_NAME];?>/images/vmm-arrow.gif"/>Over 50 Virtual Matrimony Meets Every Month
								</div>
							</div><br clear="all">	
					</div>
					<div class="fleft" style="background: url(http://<?=$_SERVER[SERVER_NAME];?>/images/omm-top-img2-new.jpg) no-repeat; width:279px; height:159px;"></div>							
					</div><br clear="all">					
						...
						<div style="padding:15px;">
								...
								<div style="width:680px;">
									...
									<div class="fleft" style="width:285px;">
										...
										<div style="float:left; width:283px; height:50px; background:url(http://<?=$_SERVER[SERVER_NAME];?>/images/inner-tab-bg.gif) repeat-x;"><div class="fright" style="padding:33px 15px 0px 0px">Do not click refresh <img src="http://<?=$_SERVER[SERVER_NAME];?>/images/omm-refresh.gif" width="11" height="13" border="0" alt=""> while the chat is on</div>
										</div>
										<div class="innertabbr1 fleft"></div>
									...
									<div class="fleft" style="width:385px;">
										<div class="innertabbr1 fleft"></div>
										<div style="float:left; width:383px; height:50px; background:url(http://<?=$_SERVER[SERVER_NAME];?>/images/inner-tab-bg.gif) repeat-x;"><div class="mediuntxt boldtxt" style="padding:33px 0px 0px 10px">Search</div>
										</div>
										<div class="innertabbr1 fleft"></div>
										<div style="width:383px !important;width:385px;height:500px !important;height:445px;border: 1px solid #C9D4AE;border-top:0px;">
										
											<div style="padding: 0px 10px 0px 10px;">
											<div class="vdotline1" style="margin:5px 0px;"><img src="http://<?=$_SERVER[SERVER_NAME];?>/images/trans.gif" height="1" width="100%"/></div><br clear="all">
													<!--Search Form-->
...
<b>Chat Dos and Don'ts </b><br><img src="http://<?=$_SERVER[SERVER_NAME];?>/images/trans.gif" width="1" height="5"><br>
In the chat room people have only two ways of judging what you're thinking. One is by the words you choose and the other is by the manners you use. So be as polite as possible and choose your words wisely.<br><img src="http://<?=$_SERVER[SERVER_NAME];?>/images/trans.gif" width="1" height="5"><br>

<b>Dos for any message</b><br><img src="http://<?=$_SERVER[SERVER_NAME];?>/images/trans.gif" width="1" height="5"><br>
...
<b>Don'ts for any message</b><br><img src="http://<?=$_SERVER[SERVER_NAME];?>/images/trans.gif" width="1" height="5"><br>
...
function launchmsg()
{
	if(xhr.readyState  == 4)
	{
		if(xhr.status  ==200) {
			...
			if(xhr.responseText!=null && xhr.responseText!=""){addingUserArray(xhr.responseText);current_pg="";}}
...
{    
	...
	{  
		...
		{ 
			...
			{
				html += "<div id='"+matriId+"' class='fleft' style='width:30px;'><a href='#' class='clr1' target='_blank' onmouseover=\"ddrivetipImg('"+details[12]+"','','75')\" onmouseout=\"hideddrivetip();\"><img src='http://<?=$_SERVER[SERVER_NAME];?>/images/omm-ph-icon.gif' width='16' height='12' border='0' alt=''  ></a></div>";
			}
			
			//Mouseover Content disp
			//alert(online_users[i]);
			html +="<div class='fleft' style='width:70px;'><a href='http://www."+domain_value+"matrimony.com/profiledetail/index.php?act=fullprofile&id="+matriId.toUpperCase()+"' class='clr1 boldtxt' target='_blank' onmouseover=\"ddrivetip('"+online_users[i]+"');\" onmouseout=\"hideddrivetip();\">"+matriId.toUpperCase()+"</a></div>	<div class='fleft' style='width:50px;'>"+details[2]+" yrs  </div>	<div class='fleft' style='width:50px;'>"+ heightVal(details[3])+"</div>";

			//chat
			if(url == "chat") {   html += "<div id='ch-"+matriId+"'><a href=\"javascript:openchat('c-"+matriId+"','"+evid+"');\" class='clr1'>Chat <img src='http://<?=$_SERVER[SERVER_NAME];?>/images/omm-chat-icon.gif' width='16' height='15' border='0' alt=''></a></div>"; } 
			else { html += "<div id='ch-"+matriId+"'><a href='"+url+"' class='clr1' onClick='log()'>Chat <img src='http://<?=$_SERVER[SERVER_NAME];?>/images/omm-chat-icon.gif' width='16' height='15' border='0' alt=''></a></div>"; }
			...
			html +="<div class='vdotline1' style='margin:5px 0px;'><img src='http://<?=$_SERVER[SERVER_NAME];?>/images/trans.gif' height='1' width='100%'/></div>";
			html += "</div>";
			...
			//{ 
				...
				{  
					...
					//chat
					if(url == "chat") {   html += "<div id='ch-"+matriId+"'><a href=\"javascript:openchat('c-"+matriId+"','"+evid+"');\" class='clr1'>Chat <img src='http://<?=$_SERVER[SERVER_NAME];?>/images/omm-chat-icon.gif' width='16' height='15' border='0' alt=''></a></div>"; } 
					else { html += "<div id='ch-"+matriId+"'><a href='"+url+"' onClick='log()'  class='clr1'>Chat <img src='http://<?=$_SERVER[SERVER_NAME];?>/images/omm-chat-icon.gif' width='16' height='15' border='0' alt=''></a></div>"; }
					//left the chat
					html += "<div id='lg-"+matriId+"' style='display:none'><font class='clr1'>left the chat</font>&nbsp;&nbsp;</div>";
					//blocked
					html += "<div id='bb-"+matriId+"' style='display:none'><font class='clr1'><b>blocked</b></font></div>";
	...
	//var str="#";
	   ...
	   if(msg != null && msg != 'null'){
			...
			{ //var winstat=openPop(winind,id,msg,evid);
			      if( id != null && id != 'null'){
				   if(id.indexOf(".") != -1){
					   //alert("BM Broad Cast Message: "+msg);
				...
				else 	
				{
					...
					{   
						...
						{ 
							...
							{
								html += "<div id='"+matriId[0]+"' class='fleft' style='width:30px;'><a href='#' class='clr1' target='_blank' onmouseover=\"ddrivetipImg('"+details[12]+"','','75');\" onmouseout=\"hideddrivetip();\"><img src='http://<?=$_SERVER[SERVER_NAME];?>/images/omm-ph-icon.gif' width='16' height='12' border='0' alt=''  ></a></div>";
							}
							
							//Mouseover text disp
							html+="<div class='fleft' style='width:70px;'><a href='http://www."+domain_value+"matrimony.com/profiledetail/index.php?act=fullprofile&id="+matriId[0].toUpperCase()+"' class='clr1 boldtxt' target='_blank' onmouseover=\"ddrivetip('"+original+"');\" onmouseout=\"hideddrivetip();\">"+matriId[0].toUpperCase()+"</a></div>	<div class='fleft' style='width:50px;'>"+details[2]+" yrs  </div>	<div class='fleft' style='width:50px;'>"+ heightVal(details[3])+"</div>";																	
							//chat
							if(url == "chat") {   html += "<div id='ch-"+matriId[0]+"'><a href=\"javascript:openchat('c-"+matriId[0]+"','"+evid+"');\" class='clr1'>Chat <img src='http://<?=$_SERVER[SERVER_NAME];?>/images/omm-chat-icon.gif' width='16' height='15' border='0' alt=''></a></div>"; } 
							else { html += "<div id='ch-"+matriId[0]+"'><a href='"+url+"' onClick='log()' class='clr1'>Chat <img src='http://<?=$_SERVER[SERVER_NAME];?>/images/omm-chat-icon.gif' width='16' height='15' border='0' alt=''></a></div>"; }
						...
						//{
							...
							{ 
								...
								{ 
									...
									html+="<div class='fleft' style='width:70px;'><a href='http://www."+domain_value+"matrimony.com/profiledetail/index.php?act=fullprofile&id="+matriId[0].toUpperCase()+"' class='clr1 boldtxt' target='_blank' onmouseover=\"ddrivetip('"+original+"');\" onmouseout=\"hideddrivetip('"+online_users[i]+"');\">"+matriId[0].toUpperCase()+"</a></div>	<div class='fleft' style='width:50px;'>"+details[2]+" yrs  </div>	<div class='fleft' style='width:50px;'>"+ heightVal(details[3])+"</div>";
									
									//chat
									if(url == "chat") {   html += "<div id='ch-"+matriId[0]+"'><a href=\"javascript:openchat('c-"+matriId[0]+"','"+evid+"');\" class='clr1'>Chat <img src='http://<?=$_SERVER[SERVER_NAME];?>/images/omm-chat-icon.gif' width='16' height='15' border='0' alt=''></a></div>"; } 
									else { html += "<div id='ch-"+matriId[0]+"'><a href='"+url+"' class='clr1' onClick='log()'>Chat <img src='http://<?=$_SERVER[SERVER_NAME];?>/images/omm-chat-icon.gif' width='16' height='15' border='0' alt=''></a></div>"; }
	...
	if(search!="" && search!=null && search!="null") 
	{
		...
		if(search_array.indexOf("#")!=-1)
		{
			...
			{  
				...
				//height
				html+="<div class='fleft' style='width:70px;'><a href='http://www."+domain_value+"matrimony.com/profiledetail/index.php?act=fullprofile&id="+matriId+"' class='clr1 boldtxt' target='_blank' onmouseover=\"ddrivetip('"+online_users[str_search[i]]+"');\" onmouseout=\"hideddrivetip();\">"+matriId.toUpperCase()+"</a></div>	<div class='fleft' style='width:50px;'>"+details[2]+" yrs  </div>	<div class='fleft' style='width:50px;'>"+ heightVal(details[3])+"</div>";
