...
$reg_query="select EventId  from ".$DBNAME['ONLINESWAYAMVARAM'].".".$TABLE['ONLINESWAYAMVARAMCHATCONFIGURATIONS']." where CURDATE()='".$evt_date."' and (time('".$time_date_checking."')>=SUBTIME(EventStartTime,'00:30:00') and time('".$time_date_checking."')<=EventEndTime) and  EventId=$evid";
...
$query = "select MatriId,EntryType,Gender,Caste,Language,Religion,CasteNoBar from ".$profiletable."  where MatriId='$matriidVal' and Validated=1 and Authorized = 1 and Status<2";
											...
											<div style="padding:5px 0px 5px 11px;">
												...
												<div class="bl" >
													<div class="br" >
															...
															<FORM name="ClassifiedForm" action="vmlogincnb.php?evid=<?=$evid?>" method=post onSubmit="return validate();">
